...
public class Ellipsoid extends UVShape
{
    ...
    {
        double x = ax.value*Math.cos(u)*Math.cos(v);
        double y = ay.value*Math.sin(u)*Math.cos(v);
        double z = az.value*Math.sin(v);
    ...
    {
    	double x = ay.value*az.value*Math.cos(u)*Math.cos(v);
        double y = ax.value*az.value*Math.sin(u)*Math.cos(v);
        double z = ax.value*ay.value*Math.sin(v);
